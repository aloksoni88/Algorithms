...
public class PrintLongestRepeatingSubsequence {
	...
	public static void main(String[] args) {
		...
		String lrs = lrsRecursive(str, str2, str.length(), str2.length());
		System.out.println(" Longest repeating subsequence is " + lrs);
	}
	...
	private static String lrsRecursive(String str1, String str2, int m, int n) {
		if (m == 0 || n == 0) {
			return "";
		}
		if (str1.charAt(m - 1) == str2.charAt(n - 1) && m != n) {
			return str1.charAt(m-1) + lrsRecursive(str1, str2, m - 1, n - 1);
		} else {
			String s1 = lrsRecursive(str1, str2, m, n - 1);
			String s2 = lrsRecursive(str1, str2, m-1, n);
